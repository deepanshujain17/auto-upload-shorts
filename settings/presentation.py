class HTMLSettings:
    CARD_WIDTH = 1200  # Updated from 720 to 1480 to match earlier cards
    CARD_HEIGHT = 1440
    TITLE_FONT_SIZE = 32  # Doubled from 28 to maintain proportion with wider card
    DESCRIPTION_FONT_SIZE = 22  # Doubled from 18 to maintain proportion
